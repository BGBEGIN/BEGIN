 ...
 */
function addorder() {
    var postdata = "order_type=" + order_type + "&order_pid=" + order_pid + "&order_price=" + order_price + "&order_sen=" + order_sen + "&order_shouyi=" + order_shouyi + "&order_kuishun=" + order_kuishun + "&newprice=" + newprice+"&type="+type;
    ...
    if (order_price < order_min_price) {
        err_info(b61 + order_min_price);
        return;
    }
    if (order_price > order_max_price) {
        err_info(b62 + order_max_price);
        return;
    }
